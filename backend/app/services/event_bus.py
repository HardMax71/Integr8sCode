...
class EventBus:
    ...
    async def process_kafka_message(self) -> None:
        """Process a single message from Kafka consumer.

        Called by DI provider's background task. Filters out self-published messages.
        """
        try:
