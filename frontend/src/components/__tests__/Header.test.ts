...
describe('Header', () => {
    ...
    describe('authenticated state', () => {
        beforeEach(() => {
            setAuth(true, 'testuser', 'user', 'test@example.com');
        });
    ...
    describe('admin user', () => {
        beforeEach(() => {
            setAuth(true, 'admin', 'admin', 'admin@example.com');
        });
        ...
        it('Admin button navigates to admin panel', async () => {
            ...
            await waitFor(() => {
                expect(router.goto).toHaveBeenCalledWith('/admin/events');
            });
        });
    });
    ...
    describe('mobile menu', () => {
        ...
        it.each([
            { isAuth: false, username: null, role: null, expectedContent: ['Login', 'Register'] },
            {
                ...
                username: 'mobileuser',
                role: 'user',
                expectedContent: ['mobileuser', 'Settings', 'Logout'],
            },
