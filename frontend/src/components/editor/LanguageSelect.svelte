...
<div class="relative">
    <button
        ...
        onclick={() => {
            ...
            if (showOptions) focusedLangIndex = 0;
        }}
    ...
    >
        ...
        <span
            class="ml-2 shrink-0 text-fg-muted dark:text-dark-fg-muted transform transition-transform"
                ...
                {#each Object.entries(runtimes) as [l, info], i (l)}
                    ...
                    >
                        ...
                        {#if hoveredLang === l && info.versions.length > 0}
                            <div
                                class="absolute left-full top-0 -mt-1 ml-1 w-20 bg-bg-alt dark:bg-dark-bg-alt rounded-lg shadow-lg ring-1 ring-black/5 dark:ring-white/10 z-40"
                                role="menu"
