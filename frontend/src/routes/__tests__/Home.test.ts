...
describe('Home', () => {
    ...
    it.each([
        ...
        [
            'Secure & Efficient',
            'Strict resource limits (CPU, Memory, Time) and network restrictions ensure safe code execution.',
        ],
        [
            'Real-time Results',
            'Get immediate feedback with live execution status updates and detailed output upon completion.',
        ],
