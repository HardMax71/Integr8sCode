...
class SavedScriptService:
    ...
    async def create_saved_script(self, saved_script_create: SavedScriptCreate, user_id: str) -> SavedScriptInDB:
        saved_script_in_db = SavedScriptInDB(**saved_script_create.dict(), user_id=user_id)
