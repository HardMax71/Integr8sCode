...
class CacheControlMiddleware(BaseHTTPMiddleware):
    """
    Middleware to add cache control headers to specific endpoints.
    """

    def __init__(self, app: ASGIApp):
        super().__init__(app)
        # Define cache policies for specific endpoints
        self.cache_policies: Dict[str, str] = {
            ...
            "/api/v1/auth/verify-token": "private, max-age=30",  # 30 seconds
