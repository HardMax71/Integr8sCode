 ...
 * Get Result
 */
export const getResultApiV1ResultExecutionIdGet = <ThrowOnError extends boolean = false>(options: Options<GetResultApiV1ResultExecutionIdGetData, ThrowOnError>) => (options.client ?? client).get<GetResultApiV1ResultExecutionIdGetResponses, GetResultApiV1ResultExecutionIdGetErrors, ThrowOnError>({ url: '/api/v1/result/{execution_id}', ...options });

/**
 * Cancel Execution
 */
export const cancelExecutionApiV1ExecutionIdCancelPost = <ThrowOnError extends boolean = false>(options: Options<CancelExecutionApiV1ExecutionIdCancelPostData, ThrowOnError>) => (options.client ?? client).post<CancelExecutionApiV1ExecutionIdCancelPostResponses, CancelExecutionApiV1ExecutionIdCancelPostErrors, ThrowOnError>({
 ...
 */
export const retryExecutionApiV1ExecutionIdRetryPost = <ThrowOnError extends boolean = false>(options: Options<RetryExecutionApiV1ExecutionIdRetryPostData, ThrowOnError>) => (options.client ?? client).post<RetryExecutionApiV1ExecutionIdRetryPostResponses, RetryExecutionApiV1ExecutionIdRetryPostErrors, ThrowOnError>({
 ...
 */
export const deleteExecutionApiV1ExecutionIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteExecutionApiV1ExecutionIdDeleteData, ThrowOnError>) => (options.client ?? client).delete<DeleteExecutionApiV1ExecutionIdDeleteResponses, DeleteExecutionApiV1ExecutionIdDeleteErrors, ThrowOnError>({ url: '/api/v1/{execution_id}', ...options });
 ...
 */
export const sseHealthApiV1EventsHealthGet = <ThrowOnError extends boolean = false>(options?: Options<SseHealthApiV1EventsHealthGetData, ThrowOnError>) => (options?.client ?? client).get<SseHealthApiV1EventsHealthGetResponses, unknown, ThrowOnError>({ url: '/api/v1/events/health', ...options });
