...
class TestSavedScriptsReal:
    ...
    async def test_update_saved_script(self, client: AsyncClient, shared_user: Dict[str, str]) -> None:
        ...
        assert updated_script.created_at.isoformat() == original_created_at.replace('Z', '+00:00')
    ...
    @pytest.mark.asyncio
    async def test_cannot_access_other_users_scripts(self, client: AsyncClient, shared_user: Dict[str, str], shared_admin: Dict[str, str]) -> None:
