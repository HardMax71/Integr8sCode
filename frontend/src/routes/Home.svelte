...
<div>
  ...
  <section class="bg-bg-default dark:bg-dark-bg-default py-16 sm:py-20 lg:py-28 px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-20">
    <div class="mx-auto max-w-full text-center mb-12 sm:mb-16">
         <h2 class="text-sm sm:text-base font-semibold leading-7 text-primary-dark dark:text-primary-light hero-animate-fly-in uppercase tracking-wider" style="--fly-delay: 600ms;">Core Features</h2>
         <p class="mt-2 text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-fg-default dark:text-dark-fg-default hero-animate-fly-in" style="--fly-delay: 700ms;">
             Everything you need for quick execution.
         </p>
         <div class="mx-auto mt-6 w-24 h-1 bg-gradient-to-r from-transparent via-primary to-transparent hero-animate-fly-in" style="--fly-delay: 800ms;"></div>
    </div>
