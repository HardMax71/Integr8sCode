...
class PodBuilder:
    ...
    def build_config_map(
        ...
        return k8s_client.V1ConfigMap(
            ...
            data={
                command.runtime_filename: script_content,
    ...
    def _build_pod_spec(
        ...
        spec = k8s_client.V1PodSpec(
            ...
            volumes=[
                    ...
                    config_map=k8s_client.V1ConfigMapVolumeSource(
                        ...
                        items=[
                            k8s_client.V1KeyToPath(
                                key=command.runtime_filename,
                                path=command.runtime_filename
                            )
                        ]
                    )
                ),
                ...
                k8s_client.V1Volume(
                    name="output-volume",
                    empty_dir=k8s_client.V1EmptyDirVolumeSource(size_limit="10Mi")
                ),
                k8s_client.V1Volume(
                    name="tmp-volume",
                    empty_dir=k8s_client.V1EmptyDirVolumeSource(size_limit="10Mi")
