 ...
 */
export const exportEventsApiV1AdminEventsExportExportFormatGet = <ThrowOnError extends boolean = false>(options: Options<ExportEventsApiV1AdminEventsExportExportFormatGetData, ThrowOnError>) => (options.client ?? client).get<ExportEventsApiV1AdminEventsExportExportFormatGetResponses, ExportEventsApiV1AdminEventsExportExportFormatGetErrors, ThrowOnError>({ url: '/api/v1/admin/events/export/{export_format}', ...options });
 ...
 */
export const streamReplayStatusApiV1AdminEventsReplaySessionIdStatusGet = <ThrowOnError extends boolean = false>(options: Options<StreamReplayStatusApiV1AdminEventsReplaySessionIdStatusGetData, ThrowOnError>) => (options.client ?? client).sse.get<StreamReplayStatusApiV1AdminEventsReplaySessionIdStatusGetResponses, StreamReplayStatusApiV1AdminEventsReplaySessionIdStatusGetErrors, ThrowOnError>({ url: '/api/v1/admin/events/replay/{session_id}/status', ...options });

/**
 * List Executions
 */
export const listExecutionsApiV1AdminExecutionsGet = <ThrowOnError extends boolean = false>(options?: Options<ListExecutionsApiV1AdminExecutionsGetData, ThrowOnError>) => (options?.client ?? client).get<ListExecutionsApiV1AdminExecutionsGetResponses, ListExecutionsApiV1AdminExecutionsGetErrors, ThrowOnError>({ url: '/api/v1/admin/executions/', ...options });

/**
 * Update Priority
 */
export const updatePriorityApiV1AdminExecutionsExecutionIdPriorityPut = <ThrowOnError extends boolean = false>(options: Options<UpdatePriorityApiV1AdminExecutionsExecutionIdPriorityPutData, ThrowOnError>) => (options.client ?? client).put<UpdatePriorityApiV1AdminExecutionsExecutionIdPriorityPutResponses, UpdatePriorityApiV1AdminExecutionsExecutionIdPriorityPutErrors, ThrowOnError>({
 ...
 * Get Queue Status
 */
export const getQueueStatusApiV1AdminExecutionsQueueGet = <ThrowOnError extends boolean = false>(options?: Options<GetQueueStatusApiV1AdminExecutionsQueueGetData, ThrowOnError>) => (options?.client ?? client).get<GetQueueStatusApiV1AdminExecutionsQueueGetResponses, GetQueueStatusApiV1AdminExecutionsQueueGetErrors, ThrowOnError>({ url: '/api/v1/admin/executions/queue', ...options });
 ...
 */
export const getDefaultRateLimitRulesApiV1AdminRateLimitsDefaultsGet = <ThrowOnError extends boolean = false>(options?: Options<GetDefaultRateLimitRulesApiV1AdminRateLimitsDefaultsGetData, ThrowOnError>) => (options?.client ?? client).get<GetDefaultRateLimitRulesApiV1AdminRateLimitsDefaultsGetResponses, unknown, ThrowOnError>({ url: '/api/v1/admin/rate-limits/defaults', ...options });
 ...
 */
export const getUserRateLimitsApiV1AdminRateLimitsUserIdGet = <ThrowOnError extends boolean = false>(options: Options<GetUserRateLimitsApiV1AdminRateLimitsUserIdGetData, ThrowOnError>) => (options.client ?? client).get<GetUserRateLimitsApiV1AdminRateLimitsUserIdGetResponses, GetUserRateLimitsApiV1AdminRateLimitsUserIdGetErrors, ThrowOnError>({ url: '/api/v1/admin/rate-limits/{user_id}', ...options });
 ...
 */
export const updateUserRateLimitsApiV1AdminRateLimitsUserIdPut = <ThrowOnError extends boolean = false>(options: Options<UpdateUserRateLimitsApiV1AdminRateLimitsUserIdPutData, ThrowOnError>) => (options.client ?? client).put<UpdateUserRateLimitsApiV1AdminRateLimitsUserIdPutResponses, UpdateUserRateLimitsApiV1AdminRateLimitsUserIdPutErrors, ThrowOnError>({
 ...
 */
export const resetUserRateLimitsApiV1AdminRateLimitsUserIdResetPost = <ThrowOnError extends boolean = false>(options: Options<ResetUserRateLimitsApiV1AdminRateLimitsUserIdResetPostData, ThrowOnError>) => (options.client ?? client).post<ResetUserRateLimitsApiV1AdminRateLimitsUserIdResetPostResponses, ResetUserRateLimitsApiV1AdminRateLimitsUserIdResetPostErrors, ThrowOnError>({ url: '/api/v1/admin/rate-limits/{user_id}/reset', ...options });
 ...
 */
export const unlockUserApiV1AdminUsersUserIdUnlockPost = <ThrowOnError extends boolean = false>(options: Options<UnlockUserApiV1AdminUsersUserIdUnlockPostData, ThrowOnError>) => (options.client ?? client).post<UnlockUserApiV1AdminUsersUserIdUnlockPostResponses, UnlockUserApiV1AdminUsersUserIdUnlockPostErrors, ThrowOnError>({ url: '/api/v1/admin/users/{user_id}/unlock', ...options });
