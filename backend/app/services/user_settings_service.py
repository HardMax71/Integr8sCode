...
class UserSettingsService:
    ...
    async def update_user_settings(
        ...
        # Notify other instances to invalidate their caches
        await self._sse_bus.publish_internal("user.settings.updated", {"user_id": user_id})
