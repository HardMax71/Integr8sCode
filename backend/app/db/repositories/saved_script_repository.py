...
class SavedScriptRepository:
    async def create_saved_script(self, create_data: DomainSavedScriptCreate, user_id: str) -> DomainSavedScript:
        ...
        await doc.insert()
        return DomainSavedScript(**doc.model_dump(include=set(DomainSavedScript.__dataclass_fields__)))
    ...
    async def get_saved_script(self, script_id: str, user_id: str) -> DomainSavedScript | None:
        ...
        return DomainSavedScript(**doc.model_dump(include=set(DomainSavedScript.__dataclass_fields__))) if doc else None
    ...
    async def list_saved_scripts(self, user_id: str) -> list[DomainSavedScript]:
        ...
        return [DomainSavedScript(**d.model_dump(include=set(DomainSavedScript.__dataclass_fields__))) for d in docs]
